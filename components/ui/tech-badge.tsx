...
const COLOR_MAP: Record<string, string> = {
  ...
  purple: 'border-purple-500/40 text-purple-700 dark:text-purple-400 bg-purple-500/10',
  pink: 'border-pink-500/40 text-pink-700 dark:text-pink-400 bg-pink-500/10',
  default: 'border-zinc-400/40 text-zinc-600 dark:text-zinc-300 bg-zinc-500/10',
};
